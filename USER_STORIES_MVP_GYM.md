# GetYourMentor - User stories MVP

## 1. Methode

Les user stories sont organisees par role et par priorite.
...
- En tant que sportif, je veux rechercher un coach par sport et ville afin de trouver une offre adaptee pres de chez moi.
...
- En tant que sportif, je veux contacter un coach avant de reserver afin de poser une question.
- En tant que sportif, je veux annuler une reservation selon des conditions claires afin de gerer un imprevu.
- En tant que sportif, je veux laisser un avis apres la seance afin d'aider les autres utilisateurs.

### Could have

- En tant que sportif, je veux enregistrer un coach en favori afin de le retrouver plus tard.
...
- En tant que coach, je veux voir quelques statistiques de base afin de suivre mon activite.

## 4. Admin

### Must have

- En tant qu'admin, je veux voir la liste des coachs afin de verifier les profils.
...
- En tant qu'admin, je veux rechercher un coach ou une reservation afin de traiter un support rapidement.

## 5. Club

### Must have

- En tant que club, je veux pouvoir prendre contact avec GetYourMentor afin d'explorer un partenariat.

### Should have

- En tant que club, je veux avoir une page vitrine legere afin d'exister dans l'ecosysteme sans complexifier le MVP.

## 6. Stories a exclure du MVP

- En tant que coach, je veux vendre des contenus payants.
- En tant que sportif, je veux m'abonner a du contenu premium.
- En tant que coach, je veux creer un club virtuel.
- En tant qu'utilisateur, je veux beneficier d'une IA de coaching.
- En tant qu'utilisateur, je veux une analyse video intelligente.
