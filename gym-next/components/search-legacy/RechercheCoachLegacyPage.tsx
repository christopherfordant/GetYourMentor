    ...
    <section className="sport-results">
      ...
      <div className="sport-card-grid" data-sport-grid>
        <article
          ...
          tabIndex={0}
          onClick={() => {
            window.location.href = buildPath("./selection-coachs.html", { sport: sportSlug, city: cities[0] });
          }}
          onKeyDown={(event) => {
        ...
        <article
          ...
          tabIndex={0}
          onClick={() => {
            window.location.href = buildPath("./selection-coachs.html", { sport: sportSlug, city: cities[1] });
          }}
          onKeyDown={(event) => {
            if (event.key === "Enter" || event.key === " ") {
              event.preventDefault();
        ...
        <article
          ...
          tabIndex={0}
          onClick={() => {
            window.location.href = buildPath("./selection-coachs.html", { sport: sportSlug, city: cities[2] });
          }}
          onKeyDown={(event) => {
            if (event.key === "Enter" || event.key === " ") {
              event.preventDefault();
        ...
        <article
          ...
          tabIndex={0}
          onClick={() => {
            window.location.href = buildPath("./selection-coachs.html", { sport: sportSlug, city: cities[3] });
          }}
          onKeyDown={(event) => {
            if (event.key === "Enter" || event.key === " ") {
              event.preventDefault();
        ...
        <article
          ...
          tabIndex={0}
          onClick={() => {
            window.location.href = buildPath("./selection-coachs.html", { sport: sportSlug, city: cities[4] });
          }}
          onKeyDown={(event) => {
            if (event.key === "Enter" || event.key === " ") {
              event.preventDefault();
        ...
        <article
          ...
          tabIndex={0}
          onClick={() => {
            window.location.href = buildPath("./selection-coachs.html", { sport: sportSlug, city: cities[5] });
          }}
          onKeyDown={(event) => {
            if (event.key === "Enter" || event.key === " ") {
              event.preventDefault();
